package  
{
	...
	{		
		...
		{			
			...
			new < String > ["rock", "Alternative rock", "Art rock‎", "Blues rock‎", "Celtic rock", "Christian rock‎", 
			"Comedy rock‎", "Country rock", "Dance-rock", "Deathrock", "Electronic rock‎", "Folk rock", "Funk rock‎", 
			"Garage rock‎", "Glam rock", "Hard rock‎", "Krautrock‎", "Pop rock‎", "Progressive rock‎", "Psychedelic rock", 
			"Psychobilly‎", "Rap rock‎", "Reggae rock‎", "Rock and roll", "Rock en Español‎", "Rock in Opposition‎", 
			"Rockabilly‎", "Soft rock‎", "Space rock‎", "Swamp rock", "Symphonic rock", "Synth rock", "Viking rock‎", 
			"Grunge", "Indie Rock", "Indie", "Classic rock", "Christian rock", "Alternative", "Progressive rock", "Blues rock", "Post-rock"]));
			
			colorsAndTags.push(new ColorAndTags(new Color(255, 153, 102),
			new < String > ["pop", "popular", "britpop", "dangdut", "dance-pop‎", "c-pop‎", "country pop‎", "bubblegum pop", "power pop‎", "shibuya-kei", "sophisti-pop", "surf music", "swamp pop music", "synthpop‎", "indie pop"]));
			...
			new < String > ["Hip-Hop", "Rap", "G-funk‎", "Gangsta rap‎", "Hip Hop"]));
			...
			new < String > ["Electronic", "House", "Ambient", "Acid House", "Dance", "Breakbeat", "Downtempo", "Boogie", "Crunk", "Grime", "Electroclash", "Funktronica", "Synthpop‎", "Trip Hop", "Noise Music", "Industrial Music", "Club House", "Electro Tango", "Lounge", "Trip-hop", "Chillout"]));
			...
			new < String > ["Heavy Metal", "Nu Metal", "Alternative Metal‎", "Black Metal‎", "Blackened death Metal‎", "Christian Metal‎", "Death Metal‎", "Doom Metal‎", "Extreme Metal‎", "Metalcore‎", "Industrial Metal", "Funk Metal", "Glam Metal‎", "Gothic Metal‎", "Grindcore‎", "Groove Metal‎", "Thrash Metal‎", "Progressive Metal‎", "Power Metal"]));
